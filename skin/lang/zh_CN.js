...
// Set masseges.
var pukiwiki_msg_copyed = "它将其复制到剪贴板中。";
...
var pukiwiki_msg_to_easy = "目前已变更为简单模式。\n该选项将在刷新后生效。\n\n现在就要刷新吗？";
var pukiwiki_msg_to_adv = "目前已变更为高级模式。\n该选项将在刷新后生效。\n\n现在就要刷新吗？";
var pukiwiki_msg_inline1 = "请输入插件名。[ ＆ 将被忽略 ]";
var pukiwiki_msg_inline2 = "请输入参数。[ ( )内侧 ]";
var pukiwiki_msg_inline3 = "请输入本文。[ { }内侧 ]";
var pukiwiki_msg_link = "请输入链接文本。";
var pukiwiki_msg_url = "请输入链接处的URL。";
var pukiwiki_msg_elem = "请选择做处理的对象。";
var pukiwiki_msg_unload = "您将提交您的变更吗？";
var pukiwiki_msg_cancel = "您将废弃您的变更吗？";
var pukiwiki_msg_submit = "您的变更已经提交，请确认。";
